...
> Update:
> - Update the loss funcion to follow the equation in the paper 
> - Calculate the accuracy of the original unlabeled dataset instead of the rest unlabeled dataset


Ref: [origin implementation](https://github.com/benedekrozemberczki/SEAL-CI)
